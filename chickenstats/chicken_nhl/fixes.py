...
def api_events_fixes(game_id, api_events):
    ...
    if game_id == 2012020660:
        ...
        new_values = {
            ...
            "player_2_height": bad_event["player_1_height"],
            "player_2_weight": bad_event["player_1_weight"],
            ...
            "player_3_height": bad_event["player_2_height"],
            "player_3_weight": bad_event["player_2_weight"],
    ...
    if game_id == 2013020445:
        ...
        new_values = {
            ...
            "player_1_height": bad_event["player_2_height"],
            "player_1_weight": bad_event["player_2_weight"],
            "player_2": bad_event["player_1"],
            "player_2_eh_id": bad_event["player_1_eh_id"],
            "player_2_api_id": bad_event["player_1_api_id"],
            "player_2_hand": bad_event["player_1_hand"],
    ...
    if game_id == 2014020120:
        ...
        bad_idxs = {
            346: {"player_2_type": "DREWBY", "player_3_type": "SERVEDBY"},
            378: {
                "player_1": "MATT BELESKEY",
        ...
        bad_events = {
            x["event_idx"]: x for x in api_events if x["event_idx"] in bad_idxs.keys()
        }
    ...
    if game_id == 2014021127:
        ...
        bad_idxs = {
            294: {"period_seconds": 1124, "period_time": "18:44", "game_seconds": 3524},
    ...
    if game_id == 2016021165:
        ...
        new_values = {
            ...
            "player_2_height": bad_event["player_3_height"],
            "player_2_weight": bad_event["player_3_weight"],
    ...
    if game_id == 2018021133:
        ...
        new_values = {"event_team": "TBL", "event_team_name": "TAMPA BAY LIGHTNING"}
    ...
    if game_id == 2019020215:
        ...
        bad_faceoffs = [
            x
            for x in api_events
            if (x["game_seconds"] in bad_faceoffs and x["event"] == "FAC")
        ]
        ...
        for bad_faceoff in bad_faceoffs:
            ...
            new_values = {
                ...
                "player_1_height": bad_faceoff["player_2_height"],
                "player_1_weight": bad_faceoff["player_2_weight"],
                ...
                "player_2_height": bad_faceoff["player_1_height"],
                "player_2_weight": bad_faceoff["player_1_weight"],
    ...
    if game_id == 2019020840:
        ...
        bad_idxs = {
            313: {"period_seconds": 1112, "period_time": "18:32", "game_seconds": 3512},
        }
    ...
    if game_id == 2019020876:
        ...
        bad_idxs = {
            315: {"period_seconds": 1088, "period_time": "18:08", "game_seconds": 3488},
    ...
    if game_id == 2020020039:
        ...
        bad_idxs = {
            91: {"period_seconds": 46, "period_time": "0:46", "game_seconds": 1246,},
            93: {
                "period_seconds": 48,
                "period_time": "0:48",
                "game_seconds": 1248,
    ...
    if game_id == 2020020162:
        ...
        bad_event = [
            x for x in api_events if x["event_idx"] == 260 and x["event"] == "GOAL"
        ][0]
    ...
    if game_id == 2020020810:
        ...
        bad_event = [
            x for x in api_events if x["event_idx"] == 224 and x["event"] == "GOAL"
        ][0]

        new_values = {
            "player_2": "HAYDN FLEURY",
    ...
    if game_id == 2020020860:
        ...
        bad_shots = {
            3869: {"period_seconds": 270, "period_time": "4:30", "game_seconds": 3870},
        }
    ...
    if game_id == 2021020039:
        ...
        bad_hits = {
            3381: {"period_seconds": 980, "period_time": "16:20", "game_seconds": 3380},
        }
    ...
    if game_id == 2021020347:
        ...
        bad_shots = {
            2726: {"period_seconds": 321, "period_time": "5:21", "game_seconds": 2721},
        }
    ...
    if game_id == 2021020537:
        ...
        bad_hits = {
            3627: {"period_seconds": 28, "period_time": "0:28", "game_seconds": 3628},
        }
    ...
    if game_id == 2021020566:
        ...
        bad_idxs = {
            6: {"period_seconds": 56, "period_time": "0:56", "game_seconds": 56,},
    ...
    if game_id == 2021020682:
        ...
        bad_faceoffs = {
            1695: {"period_seconds": 492, "period_time": "8:12", "game_seconds": 1692},
        }
    ...
    if game_id == 2021020795:
        ...
        bad_blocks = {
            3028: {"period_seconds": 626, "period_time": "10:26", "game_seconds": 3026},
        }
    ...
    if game_id == 2021020997:
        ...
        bad_gives = {
            1418: {"period_seconds": 194, "period_time": "3:14", "game_seconds": 1394},
        }
    ...
    if game_id == 2021021039:
        ...
        bad_shots = {
            58: {"period_seconds": 57, "period_time": "0:57", "game_seconds": 57},
        }
...
def api_rosters_fixes(game_id, api_roster):
    ...
    if game_id == 2018020321:

        bad_player = [x for x in api_roster if x["api_id"] == 8479016][0]

        bad_player.update({"catches": "L"})
    ...
    if game_id == 2021020363:
        ...
        new_player["age"] = (
            pd.to_datetime(game_date) - pd.to_datetime(new_player["birth_date"])
        ).days / 365.2425
