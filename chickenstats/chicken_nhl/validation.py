...
XGSchema = DataFrameSchema(
    columns={
        ...
        "is_rebound": Column(int),
        "rush_attempt": Column(int),
        "is_home": Column(int),
        "seconds_since_last": Column(int),
        "distance_from_last": Column(float),
        "prior_shot_same": Column(int),
        "prior_miss_same": Column(int),
        "prior_block_same": Column(int),
        "prior_give_same": Column(int),
        "prior_take_same": Column(int),
        "prior_hit_same": Column(int),
        "prior_shot_opp": Column(int),
        "prior_miss_opp": Column(int),
        "prior_block_opp": Column(int),
        "prior_give_opp": Column(int),
        "prior_take_opp": Column(int),
        "prior_hit_opp": Column(int),
        "prior_face": Column(int),
        "backhand": Column(int),
        "bat": Column(int),
        "between_legs": Column(int),
        "cradle": Column(int),
        "deflected": Column(int),
        "poke": Column(int),
        "slap": Column(int),
        "snap": Column(int),
        "tip_in": Column(int),
        "wrap_around": Column(int),
        "wrist": Column(int),
        "strength_state_3v3": Column(int),
        "strength_state_4v4": Column(int),
        "strength_state_5v5": Column(int),
        "strength_state_3v4": Column(int),
        "strength_state_3v5": Column(int),
        "strength_state_4v5": Column(int),
        "strength_state_4v3": Column(int),
        "strength_state_5v3": Column(int),
        "strength_state_5v4": Column(int),
        "strength_state_Ev3": Column(int),
        "strength_state_Ev4": Column(int),
        "strength_state_Ev5": Column(int),
        "strength_state_3vE": Column(int),
        "strength_state_4vE": Column(int),
        "strength_state_5vE": Column(int),
    },
    strict="filter",
...
IndStatSchema = DataFrameSchema(
    columns={
        ...
        "player": Column(str),
        "player_eh_id": Column(str),
        "player_api_id": Column(int),
        "position": Column(str),
        "team": Column(str),
