...
from chickenstats.chicken_nhl.validation_pandas import ind_stats_pandera_pandas
...
def prep_ind_pandas(
    ...
    merge_list.extend(_build_merge_list(teammates=teammates, opposition=opposition))

    if opposition and "opp_team" not in merge_list:
