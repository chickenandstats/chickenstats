...
Detailed walk-throughs and explanations. See [:material-download-box: Getting Started](getting_started.md)
to download & install `chickenstats` with `pip` to get up & running in just a few minutes.

For even more in-depth materials, please consult the **[:material-bookshelf: Reference](../reference/reference.md)**
