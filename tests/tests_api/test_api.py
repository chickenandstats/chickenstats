...
class TestChickenStats:
    def test_check_pbp_game_ids(self):
        ...
        game_ids = api_instance.check_pbp_game_ids(season=[2023],
    ...
    def test_check_check_pbp_play_ids(self):
        ...
        play_ids = api_instance.check_pbp_play_ids(season=[2023],
                                                   disable_progress_bar=True)
    ...
    def test_check_stats_game_ids(self):
        ...
        game_ids = api_instance.check_stats_game_ids(season=[2023],
                                                     disable_progress_bar=True)
    ...
    def test_download_game_stats(self):
        ...
        game_stats = api_instance.download_game_stats(game_id=[2023020001],
                                                      strength_state=["5v5"],
                                                      disable_progress_bar=True)
    ...
    def test_check_team_stats_game_ids(self):
        ...
        game_ids = api_instance.check_team_stats_game_ids(season=[2023],
                                                          disable_progress_bar=True)
    ...
    def test_check_lines_game_ids(self):
        ...
        game_ids = api_instance.check_lines_game_ids(season=[2023],
                                                     disable_progress_bar=True)
